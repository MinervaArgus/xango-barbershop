...
export default function AppointPicker() {
    const s = {
        loading: false,
    ...
    const addAppointmentCallbackContinuousCase = ({
        ...
        s.setState(
            ...
            async () => {
                ...
                addCb(day, number, time, id);
                s.setState({ continuousLoading: false });
            }
        );
    };
    ...
    const { loading, continuousLoading } = s.state;
    return (
        <div>
            <h1>Appointment Picker</h1>
            <AppointmentPicker
                addAppointmentCallback={s.addAppointmentCallback}
                removeAppointmentCallback={s.removeAppointmentCallback}
            ...
            <AppointmentPicker
                addAppointmentCallback={s.addAppointmentCallbackContinuousCase}
                removeAppointmentCallback={
                    s.removeAppointmentCallbackContinuousCase
                }
                initialDay={new Date('2018-05-05')}
                days={days}
